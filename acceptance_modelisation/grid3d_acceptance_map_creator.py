...
class Grid3DAcceptanceMapCreator(BaseAcceptanceMapCreator):
    ...
    def create_acceptance_map(self, observations: Observations) -> Background3D:
        ...
        count_map_background, exp_map_background, exp_map_background_total, livetime = (
            self._create_base_computation_map(observations)
        )
        ...
        corrected_counts = (
            count_map_background_downsample.data
        ...
        #
        # plt.imshow(count_map_background_downsample.data[0])
        # plt.show()
        # plt.imshow(corrected_counts[0])
        # plt.show()
        # plt.imshow(corrected_counts[-1])
        # plt.show()
        # plt.imshow(
        #     exp_map_background_downsample.data[-1]
        #     / exp_map_background_total_downsample.data[-1]
        # )
        # plt.title("exposure ratio")
        # plt.show()
        # plt.imshow(count_map_background_downsample.data[-1])
        # plt.title("counts")
        # plt.show()
